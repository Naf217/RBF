--// Chloe X Style UI (Server Tools Edition) by Majid
...
infoText.Text = "Versi: ChloeX UI v0.2\nStatus: Aktif\n\nTampilan besar bergaya Chloe X."
...
rejoinBtn.Size = UDim2.new(0, 200, 0, 38)
...
-- Input box untuk link server
local linkBox = Instance.new("TextBox", serverFrame)
linkBox.PlaceholderText = "Tempel link server di sini..."
linkBox.Size = UDim2.new(0, 350, 0, 34)
...
joinBtn.Text = "Join"
joinBtn.Size = UDim2.new(0, 120, 0, 34)
joinBtn.Position = UDim2.new(0, 10, 0, 145)
