--// Chloe X Style UI (Server Tools v0.5) by Majid (dengan tab Player: WalkSpeed, Fly, NoClip)
...
-- ===========================
-- Player Tab (WalkSpeed + Fly + NoClip)
-- ===========================
...
local noclipToggle = createToggle(playerFrame, "NoClip", 160)

-- Some explanatory note (moved down)
...
note.Position = UDim2.new(0,10,0,200)
